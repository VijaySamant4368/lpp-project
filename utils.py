...
import osmnx as ox
from suggestions import name_to_node
import pulp as lp

GRAPH_FILE = "primary_secondary_tertiary_roads.graphml"
...
def compute_route(start_name: str, end_name: str, primary: bool = True, secondary: bool = True, tertiary: bool = True):
